...
( function(){
        try{
            ...
            window.alert("akizuki-bookmarklet v0.0.3 parse error\nhttps://tiryoh.github.io/akizuki-bookmarklet\nこのブックマークレットに関する秋月電子通商さんへのお問い合わせは控えてください。\n\nerror:"+e);
        }
        var price = "";
        for (var i = 0, len = arr.length; i < len; i++){
            price += arr[i];
        }
        var contents=document.title.substr(0,document.title.lastIndexOf(": "))+"\t"+location.href.match(/[A-Z]-\d{5}/g)+"\t"+price+"\t"+location.href;
